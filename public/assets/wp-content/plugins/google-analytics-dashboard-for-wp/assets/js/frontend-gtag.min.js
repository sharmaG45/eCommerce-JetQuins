...
var ExactMetrics = function() {
        ...
        function b(e, t, n) {
            if (!exactmetrics_frontend.v4_id || e !== 'event') {
                return
            };
            var i = n.event_category || '',
                ...
                l = p(n, null, a);
            l.action = t;
            l.send_to = exactmetrics_frontend.v4_id;
        ...
        function A(e) {
            ...
            } else if (r && window.exactmetrics_experimental_mode && r.length > 0 && document.domain.length > 0 && r !== document.domain) {
                t = 'cross-hostname'
            };
        ...
        function v(n) {
            ...
            if (a && a.href && !a.hasAttribute('xlink:href')) {
                var v = a.href,
                    ...
                    N = h(),
                    S = g(),
                    D = exactmetrics_frontend.home_url,
                    L = c(),
                    o = A(a),
                    K = T(a, n),
        ...
        function k() {
            if (exactmetrics_frontend.hash_tracking === 'true' && f != window.location.hash && exactmetrics_frontend.v4_id) {
