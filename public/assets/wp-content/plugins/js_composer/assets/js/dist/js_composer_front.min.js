        ...
        "function" != typeof window.vc_js && (window.vc_js = function() {
            ...
            function e() {
                ...
                void 0 !== window.wpb_disable_full_width_row_js && window.wpb_disable_full_width_row_js || (e = l('[data-vc-full-width="true"]'), l.each(e, function(e, t) {
                    ...
                    (u = u.length ? u : s.parent().next(".vc_row-full-width")).length && (o = parseInt(s.css("margin-left"), 10), i = parseInt(s.css("margin-right"), 10), n = 0 - u.offset().left - o, a = l(window).width(), r = {
                        position: "relative",
