! function(d) {
    woodmartThemeModule.menuSetUp = function() {
        ...
        function e() {
            woodmartThemeModule.$window.width() <= 1024 ? n.find(" > .menu-item-has-children.wd-event-hover").each(function() {
        ...
        d(".mobile-nav").find("ul.wd-nav-mobile").find(" > li").has(".wd-dropdown-menu").addClass("menu-item-has-children"), woodmartThemeModule.$document.on("click", ".wd-nav .wd-event-click > a, .wd-header-cats.wd-event-click > span", function(e) {
            e.preventDefault();
            e = d(this);
        ...
        }), "yes" === woodmart_settings.menu_item_hover_to_click_on_responsive && (e(), woodmartThemeModule.$window.on("resize", woodmartThemeModule.debounce(function() {
            e()
        }, 300)))
