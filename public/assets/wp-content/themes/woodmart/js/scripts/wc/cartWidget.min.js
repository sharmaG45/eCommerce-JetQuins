    ...
    woodmartThemeModule.cartWidget = function() {
        var e = woodmartThemeModule.$body,
            ...
            t = (e.on("click", ".cart-widget-opener", function(e) {
                u() || r() || e.preventDefault(), c() ? t() : setTimeout(function() {
                    n()
                }, 10)
                ...
                o.removeClass("wd-opened"), d.removeClass("wd-close-side-opened")
            }),
            n = function() {
                if (u() || r()) return !1;
                o.addClass("wd-opened"), d.addClass("wd-close-side-opened")
            },
            c = function() {
