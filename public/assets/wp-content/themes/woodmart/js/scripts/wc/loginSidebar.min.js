! function(c) {
    woodmartThemeModule.$document.on("wdShopPageInit", function() {
        ...
        var e = woodmartThemeModule.$body,
            o = c(".login-form-side"),
            n = c(".wd-close-side"),
            d = (c(".login-side-opener").off("click").on("click", function(e) {
                o.length && (e.preventDefault(), t() ? d() : setTimeout(function() {
                    i()
                }, 10))
            ...
            t = (0 < o.find(".woocommerce-notices-wrapper > ul").length && i(), function() {
